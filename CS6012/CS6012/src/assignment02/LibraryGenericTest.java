...
class LibraryGenericTest {
    ...
    public void stringLibraryTest() {
        ...
        assertTrue(booksCheckedOut1.contains(new LibraryBookGeneric<>(9780330351690L, "Jon Krakauer", "Into the Wild")));
        assertTrue(booksCheckedOut1.contains(new LibraryBookGeneric<>(9780374292799L, "Thomas L. Friedman", "The World is Flat")));
